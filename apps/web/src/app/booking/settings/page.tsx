        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="flex items-center gap-3">
              <label className="text-sm text-gray-600 whitespace-nowrap">予約の</label>
              <input
                type="number"
                min={0}
                max={720}
              ...
              />
              <label className="text-sm text-gray-600 whitespace-nowrap">時間前まで受付</label>
            </div>
          ...
          {/* 店舗情報 */}
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h2 className="text-base font-semibold text-gray-800 mb-4">店舗情報</h2>
